package pantsu.scrolldemo.scroll_7_parts;
...
public class ImageLoader {
    ...
    // TAG_KEY must be a specified key when setTag(TAG_KEY, value)
    private static final int TAG_KEY_URI = R.id.image_url;
    ...
    /*
    * We don't create a new Looper by Looper.prepare,
    * (and we can't operate UI expect in MainThread)
    * instead we directly use Looper in MainThread...
    */
    ...
    private static BindStrategy mDefaultBindStrategy = new BindStrategy() {
        @Override
    ...
    public static void setDefaultBindStrategy(BindStrategy defaultBindStrategy) {
        if (mDefaultBindStrategy != null) {
            mDefaultBindStrategy = defaultBindStrategy;
        }
    }
    ...
    public static ImageLoader getInstance(Context context, BindStrategy defaultBindStrategy) {
        setDefaultBindStrategy(defaultBindStrategy);
    ...
    public void bindBitmap(String uri, int default_image_id, ImageView imageView, BindStrategy bindStrategy) {
        if (bindStrategy == null)
            bindStrategy = mDefaultBindStrategy;
    ...
    public void bindBitmap(final String uri, int default_image_id, final ImageView imageView,
        ...
        bindBitmap(uri, default_image_id, imageView, reqWidth, reqHeight, mDefaultBindStrategy);
    }
    ...
    private Bitmap loadBitmap(String uri, int reqWidth, int reqHeight) {
        ...
        /*
        * For DiskLruCache is not usable, so directly decode the Url-Link
        * to produce a bitmap...
        */
    ...
    private Bitmap downloadBitmapFromUrl(String urlString) {
        ...
        try {
            ...
            Log.e(TAG, "Error int downloadBitmap: " + e);
        } finally {
            if (urlConnection != null) {
                urlConnection.disconnect();
            }
